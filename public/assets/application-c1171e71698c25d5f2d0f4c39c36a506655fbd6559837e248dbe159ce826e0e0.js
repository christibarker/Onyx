...
(function() {
  $(document).on('turbolinks:load', function() {
    return $('.destroy_enrollment').on('ajax:success', function() {
      return $(this).closest('.enrollment').remove();
    });
  });
...
(function() {
  $(document).on('turbolinks:load', function() {
    $('.destroy_lesson').on('ajax:success', function() {
      return $(this).closest('.lesson').remove();
    });
    return $('.part_description').truncate({
      lines: 1
    });
  });
...
(function() {
  $(document).on('turbolinks:load', function() {
    $('.destroy_show').on('ajax:success', function() {
      $(this).closest('.show').remove();
      return $('.add_nested_fields').click(function() {
        return $('select').material_select();
      });
    });
    return $('.part_show').truncate({
      lines: 2
    });
  });
...
(function() {
  $(document).on('turbolinks:load', function() {
    $('.destroy_teacher').on('ajax:success', function() {
      return $(this).closest('.teacher').remove();
    });
    return $('.part_bio').truncate({
      lines: 2
    });
  });
