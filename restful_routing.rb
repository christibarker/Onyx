  ...
  instructed_classes_index GET    /instructed_classes/index(.:format)    instructed_classes#index
    instructed_classes_new GET    /instructed_classes/new(.:format)      instructed_classes#new
 instructed_classes_create GET    /instructed_classes/create(.:format)   instructed_classes#create
   instructed_classes_show GET    /instructed_classes/show(.:format)     instructed_classes#show
   instructed_classes_edit GET    /instructed_classes/edit(.:format)     instructed_classes#edit
 instructed_classes_update GET    /instructed_classes/update(.:format)   instructed_classes#update
instructed_classes_destroy GET    /instructed_classes/destroy(.:format)  instructed_classes#destroy
